										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												 <TR>
													<TD>拜访客户名称：</TD>
													<TD>
														<s:select theme="simple" list="customers" name="customer.cust_id" headerKey="" headerValue="-请选择-" listKey="cust_id" listValue="cust_name"/>
													</TD>
													<TD>拜访用户名称：</TD>
													<TD>
														<s:select theme="simple" list="users" name="user.user_id" headerKey="" headerValue="-请选择-" listKey="user_id" listValue="user_name"/>
													</TD>
													<TD>拜访时间：</TD>
													<TD>
														<s:textfield theme="simple" name="visit_time" class="textbox" id="visitime" cssStyle="WIDTH: 180px" maxLength="50"/>
													</TD>
