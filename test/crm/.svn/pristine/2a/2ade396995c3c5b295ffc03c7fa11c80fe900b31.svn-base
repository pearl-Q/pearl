					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								<td>客户名称：</td>
								<td>
									<s:textfield class="textbox" id="sChannel2" style="WIDTH: 180px" maxlength="50" name="cust_name" value="%{model.cust_name }"/>
								</td>
								<td>客户级别 ：</td>
								<td>
							...
							<TR>
								...
								<td>固定电话 ：</td>
								<td>
									<s:textfield class="textbox" style="WIDTH: 180px" maxlength="50" name="cust_phone" value="%{model.cust_phone}"/>
								</td>
								<td>移动电话 ：</td>
								<td>
									<s:textfield class="textbox" style="WIDTH: 180px" maxlength="50" name="cust_mobile" value="%{model.cust_mobile}"/>
								</td>
							</TR>
